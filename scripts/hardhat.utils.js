...
async function deployContract(contractName, constructorArgs=[], verbose=false) {
    let contract;
...
async function deployWithAbiAndBytecode(contractName, abi, bytecode, verbose=false) {
